...
return [
    'd4l' => [
      'static_site_generator' => [
        ...
        'output_folder' => './docs', # you can specify an absolute or relative path
        ...
        'base_url' => '/kirby-static-github-pages/', # if the static site is not mounted to the root folder of your domain, change accordingly here
